...
public class Room3Panel extends JPanel implements GameRoom {
    ...
    private void setupRoom() {
        ...
        OutlineLabel welcomeLabel = new OutlineLabel("Welcome to Room 3, " + playerName, SwingConstants.CENTER);
...
// Bind the Escape key to the pauseGameAction for the panel
    ...
    public void displayQuestion() {
        if (currentQuestionIndex >= questions.length) {
            ...
            JOptionPane.showMessageDialog(frame, "Congratulations, you've completed Room 3!", "Room 3 Cleared", JOptionPane.PLAIN_MESSAGE, resizedIcon);
            player1.setRoom(3);
