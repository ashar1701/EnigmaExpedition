...
/**
 * The {@code Room5Panel} class represents the fifth room or level in a quiz game.
...
public class Room5Panel extends JPanel implements GameRoom {
    ...
    public String[][] questions = {
            {"What is the most abundant element in the universe?", "A. Oxygen", "B. Carbon", "C. Hydrogen", "D. Helium"},
            {"In mathematics, what is the name of a polygon with five sides?", "A. Pentagon", "B. Hexagon", "C. Octagon", "D. Decagon"},
            {"Who is known for developing the theory of relativity?", "A. Isaac Newton", "B. Albert Einstein", "C. Stephen Hawking", "D. Galileo Galilei"},
            {"Which ancient civilization built the Machu Picchu complex?", "A. The Aztecs", "B. The Mayans", "C. The Inca", "D. The Olmecs"},
            {"What scientific principle explains why a ship made of steel floats in water?", "A. Bernoulli's Principle", "B. Pascal's Law", "C. Archimedes' Principle", "D. Newton's Law of Gravitation"}
        };
    public int[] answers = {3,1,2,3,3};
    /**
     * Constructs a new {@code Room5Panel} instance for displaying and managing the fifth room of the game.
    ...
    public Room5Panel(Start startFrame,JFrame frame, Player player1) {
    ...
    private void setupRoom() {
        ...
        OutlineLabel welcomeLabel = new OutlineLabel("Welcome to Room 5, " + playerName, SwingConstants.CENTER);
        ...
        customizeComponents();
        displayQuestion();
    // Additional methods for handling questions and game logic
    ...
    public void displayQuestion() {
        if (currentQuestionIndex >= questions.length) {
            ...
            JOptionPane.showMessageDialog(frame, "Congratulations, you've successfully escaped!", "Game Over", JOptionPane.PLAIN_MESSAGE,resizedIcon);
